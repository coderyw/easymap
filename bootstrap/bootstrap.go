...
const genPackage = "github.com/coderyw/easymap/gen"
...
func (g *Generator) writeMain() (path string, err error) {
	f, err := ioutil.TempFile(filepath.Dir(g.OutName), "easymap-bootstrap")
	if err != nil {
		return "", err
	}
...
func (g *Generator) Run() error {
	...
	execArgs = append(execArgs, "-mod=mod", "-tags", g.BuildTags, filepath.Base(path))
